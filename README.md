[![Build Status](https://dev.azure.com/vivekku/DevOps_Azure_test/_apis/build/status/vickyclasses.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/vivekku/DevOps_Azure_test/_build/latest?definitionId=1&branchName=master)
